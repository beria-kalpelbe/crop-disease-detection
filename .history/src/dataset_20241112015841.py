...
class DatasetInitializer():
    ...
    def _download_file_from_drive(self, url):
        g = re.match(pat,url)
        if g:
                id = g.group(1)
                down_url = f'https://drive.google.com/uc?id={id}'
                os.system(f'gdown {down_url} -O {os.path.join(self.DATA_DIR, "images.zip")}')
    ...
    def _download_data(self):
        url_list = [
            "https://drive.google.com/file/d/1rY8pjQ27h9petBcZP0RxkYHoyu8RvToq",
            "https://drive.google.com/file/d/1iToVuuZd48c-I232GWk0FEIzeUgEPRMw",
